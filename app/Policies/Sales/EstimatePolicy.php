...
class EstimatePolicy
{
    ...
    {
        return $user->can('update_sales::estimate');
    }
    ...
    {
        return $user->can('delete_any_sales::estimate');
    }
    ...
    {
        return $user->can('force_delete_any_sales::estimate');
    }
    ...
    {
        return $user->can('restore_any_sales::estimate');
    }
